		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					LongestCount = table.Column<int>(type: "int", nullable: false),
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.CheckConstraint("CK_Note_Content_IsJson", "ISJSON(Content) = 1");
					table.ForeignKey(
			...
			migrationBuilder.InsertData(
				table: "AspNetUsers",
				columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "IsActive", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RefreshToken", "RefreshTokenExpiryTime", "SecurityStamp", "TwoFactorEnabled", "UserName" },
				values: new object[,]
				{
					{ new Guid("09097277-2705-40c2-bce5-51dbd1f4c1e6"), 0, "seed-7", "user@example.com", true, "", true, false, null, "USER@EXAMPLE.COM", "USER", "AQAAAAIAAYagAAAAEAuhHqpAULhaHJODep0CRnbKg9WhP3QybicCtGQerWqp4l5JzBb3rSr1W6IWKA61zw==", null, false, "", new DateTime(2025, 10, 9, 4, 14, 28, 887, DateTimeKind.Utc).AddTicks(9197), "seed-6", false, "user" },
					{ new Guid("33f41895-b601-4aa1-8dc4-8229a9d07008"), 0, "seed-5", "admin@example.com", true, "", true, false, null, "ADMIN@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAED+lTCLNTAJ9iWTDcjgv/7x8qPlW0pH2xzelXvaFXmOj577fV7c6TtVkmLDIYxdtgw==", null, false, "", new DateTime(2025, 10, 9, 4, 14, 28, 839, DateTimeKind.Utc).AddTicks(4387), "seed-4", false, "admin" }
				});
