...
namespace studeehub.Persistence.Migrations
{
    ...
    [Migration("20251024151525_RemoveUnuseEntities")]
    partial class RemoveUnuseEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("studeehub.Domain.Entities.Achievement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConditionValue = 3,
                            CreatedAt = new DateTime(2025, 10, 24, 15, 15, 24, 71, DateTimeKind.Utc).AddTicks(3042),
                            ...
                            RewardType = "XP",
                            RewardValue = 50,
                            UpdatedAt = new DateTime(2025, 10, 24, 15, 15, 24, 71, DateTimeKind.Utc).AddTicks(3042)
                        },
                        new
                        {
                            ...
                            ConditionType = "Streak",
                            ConditionValue = 7,
                            CreatedAt = new DateTime(2025, 10, 24, 15, 15, 24, 71, DateTimeKind.Utc).AddTicks(3051),
                            ...
                            RewardType = "XP",
                            RewardValue = 150,
                            UpdatedAt = new DateTime(2025, 10, 24, 15, 15, 24, 71, DateTimeKind.Utc).AddTicks(3051)
                        });
                });
            ...
            modelBuilder.Entity("studeehub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKtb/poWWXjseAxA7ErbghrjWATO4aEwbD5rbriumnYjueaWSUn5RKmgQKsILS7JzQ==",
                            PhoneNumberConfirmed = false,
                            PomodoroSettingId = new Guid("00000000-0000-0000-0000-000000000000"),
                            RefreshToken = "",
                            RefreshTokenExpiryTime = new DateTime(2025, 10, 31, 15, 15, 23, 975, DateTimeKind.Utc).AddTicks(1147),
                        ...
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECmM8+Cexrcr1wecnYQR8UeeyUY99EHADYuzAilYT15yzk59sRqFZuVhN3pomLTNPQ==",
                            PhoneNumberConfirmed = false,
                            PomodoroSettingId = new Guid("00000000-0000-0000-0000-000000000000"),
                            RefreshToken = "",
                            RefreshTokenExpiryTime = new DateTime(2025, 10, 31, 15, 15, 24, 22, DateTimeKind.Utc).AddTicks(6757),
